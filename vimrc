...
"    call append(line(".")+18, "")
"    call append(line(".")+19, "def main(argv=None):")
"    call append(line(".")+20, "    if argv is None:")
"    call append(line(".")+21, "        argv = sys.argv")
"    call append(line(".")+22, "    ")
"    call append(line(".")+23, "    argv_len = len(sys.argv)")
"    call append(line(".")+24, "    if argv_len < 2:")
"    call append(line(".")+25, "        os.system(__file__ + \" -h\")")
"    call append(line(".")+26, "        return 2")
"    call append(line(".")+27, "")
"    call append(line(".")+28, "if __name__=='__main__':")
"    call append(line(".")+29, "    sys.exit(main())")
"endf
"
"映射到快捷键F2,F3
